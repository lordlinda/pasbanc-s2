...
function About() {
  return (
    <Layout>
      <SEO title="About" />
      <div class="tabs" style={{ padding: "16px" }}>
        <h2>About Us</h2>
        <p>
        ...
        <ul class="nav nav-tabs" style={{ flexWrap: "nowrap" }}>
          <li class="active">
            ...
            <div class="container">
              ...
              <a class="toolTip" href="#" data-placement="auto">
                ...
                <span class="custom">
                  ...
                  using a CSS tooltip, feel free to get creative and produce
                  your own!
                </span>
              </a>
              ,<h1>Value one</h1>
              <p>
                ...
                Dolore, alias, neque. Iure, repellat perspiciatis consectetur.
                Odio consequuntur magnam, nemo voluptas laudantium temporibus
                debitis, explicabo! Quos non, accusamus architecto porro rerum.
              </p>
              <h1>Value one</h1>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
